report 50005 "Sales Invoice"
{
    ...
    ApplicationArea = All;
    Caption = 'Tax Invoice-SSPL1';
    DefaultLayout = RDLC;
    //Tax Invoice  For SSPL-REHAN SAYED
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(Policy_No; "Policy No")
            {

            }
            column(Policy_From_Date; "Policy From Date")
            {

            }
            column(Policy_To_Date; "Policy To Date")
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        begin
                            ...
                            //Dispatch Details
                            ShippingAgent.Reset();
                            ShippingAgent.SetRange(Code, "Sales Invoice Header"."Shipping Agent Code");
                            ...
                            SalesInvoiceLine.SETFILTER("No.", CustomerPostingGrp."Invoice Rounding Account");
                            if SalesInvoiceLine.FindFirst() then begin
                                RoundingAmount := SalesInvoiceLine."Line Amount";
                            end;
                            ...
                            Total := Total + "Sales Invoice Line"."Line Amount";    // Amt;
